...
#define KEY_LEFT		PORTDbits.RD2  //向左键
#define KEY_RIGHT		PORTDbits.RD5  //向右键
#define KEY_SET			PORTDbits.RD1  //设置键
#define KEY_DEL 		PORTDbits.RD6  //减号键
#define KEY_RUN			PORTDbits.RD4  //运行键
#define KEY_OK			PORTGbits.RG7  //确认键
#define KEY_QUERY		PORTGbits.RG6  //查询键

#define KEY_ADD_DIR			TRISDbits.TRISD7  //加号键的方向寄存器
#define KEY_LEFT_DIR		TRISDbits.TRISD2  //左键的方向寄存器
...
//LED
#define LED_SET_DIR			TRISDbits.TRISD3  //设置灯方向寄存器，DIR:方向
#define LED_RUN_DIR			TRISFbits.TRISF0  //运行灯方向寄存器
#define LED_SET_ON			LATDbits.LATD3=0   //设置灯亮
#define LED_SET_OFF			LATDbits.LATD3=1   //设置灯灭
